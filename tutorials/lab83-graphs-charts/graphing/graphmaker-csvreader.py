...
def parsecsvdata():
    ...
    # open csv data
    with open("/home/student/mycode/tutorials/lab83-graphs-charts/graphing/2018summary.csv",\
     "r") as downtime:
...
def main():
    ...
    plt.savefig("/home/student/mycode/tutorials/lab83-graphs-charts/graphing/2018summaryv2.png")
    # Save to "~/static"
